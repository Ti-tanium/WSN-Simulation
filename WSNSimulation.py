...
def run_sim(n,greedy=False,adaptive_duty_cycle=False,adaptive_radius=False,ABRCD=False,AC=False):
    ...
    for i in range(0,n):
        ...
        updated_num,time_used=start_dissenminating(network,greedy,adaptive_duty_cycle,adaptive_radius,AC)
...
#    display_energy_residual_heatmap(network,mean_energy_remain)
    ...
    lifetime=network[0].E0/(network[0].E0-min(mean_energy_remain))
    variance=0
    ...
    print("Average Network lifetime:"+str(lifetime))
